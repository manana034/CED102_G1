...
(1, 'archie', 'archie', '123456'),
(2, 'yimming', 'yimming', 'hohoho9487'),
(3, 'yiting', 'manana034', 'tp6u4wu/6'),
(4, 'Alison', 'Alison', '123456');
...
CREATE TABLE IF NOT EXISTS `dietrecord` (
  `dtRNo` int NOT NULL AUTO_INCREMENT,
  `mNo` int NOT NULL,
...
(1, 1, '2370.00', '2021-02-21', 1),
(2, 1, '948.00', '2021-02-22', 2),
(3, 1, '270.00', '2021-02-23', 2),
(4, 1, '1015.00', '2021-02-23', 3),
(5, 1, '1585.00', '2021-02-24', 2),
(6, 2, '1650.00', '2021-02-24', 2),
(7, 2, '800.00', '2021-02-24', 3),
(8, 3, '3180.00', '2021-02-25', 3),
(9, 3, '3815.00', '2021-02-26', 1),
(10, 2, '1815.00', '2021-02-26', 2),
(11, 1, '1493.00', '2021-02-26', 3),
(12, 1, '3414.00', '2021-02-27', 1),
(13, 3, '3700.00', '2021-02-28', 1),
(14, 1, '1964.00', '2021-02-28', 3),
(15, 2, '1553.00', '2021-02-28', 3),
(16, 3, '3676.00', '2021-02-28', 3),
(17, 1, '394.00', '2021-03-02', 1),
(18, 1, '1270.00', '2021-03-02', 2),
(19, 3, '3150.00', '2021-03-02', 2),
(20, 1, '1404.00', '2021-03-03', 2),
(21, 1, '694.00', '2021-03-04', 2),
(22, 1, '850.00', '2021-03-04', 3),
(23, 4, '1270.00', '2021-03-04', 3),
(24, 2, '394.00', '2021-03-05', 1),
(25, 3, '2920.00', '2021-03-05', 2),
(26, 1, '971.00', '2021-03-05', 1),
(27, 1, '1144.00', '2021-03-06', 2),
(28, 3, '3150.00', '2021-03-06', 2),
(29, 2, '694.00', '2021-03-06', 3),
(30, 2, '720.00', '2021-03-07', 1),
(31, 3, '3180.00', '2021-03-07', 1),
(32, 1, '960.00', '2021-03-07', 1),
(33, 1, '894.00', '2021-03-08', 2),
(34, 1, '927.00', '2021-03-09', 3),
(35, 1, '1735.00', '2021-03-10', 3),
(36, 2, '550.00', '2021-03-11', 3),
(37, 3, '2920.00', '2021-03-11', 3),
(38, 1, '897.00', '2021-03-11', 1),
(39, 3, '3540.00', '2021-03-12', 2),
(40, 1, '1869.00', '2021-03-13', 3),
(41, 1, '701.00', '2021-03-14', 1),
(42, 3, '2340.00', '2021-03-14', 2),
(43, 3, '2340.00', '2021-03-15', 1),
(44, 1, '850.00', '2021-03-15', 3),
(45, 1, '615.00', '2021-03-16', 1),
(46, 2, '676.00', '2021-03-16', 2),
(47, 3, '3000.00', '2021-03-16', 2),
(48, 1, '480.00', '2021-03-17', 3),
(49, 4, '394.00', '2021-03-17', 3),
(50, 1, '650.00', '2021-03-18', 1),
(51, 1, '1375.00', '2021-03-20', 2),
(52, 2, '1100.00', '2021-03-21', 3),
(53, 2, '694.00', '2021-03-22', 1),
(54, 1, '635.00', '2021-03-22', 1),
(55, 3, '2920.00', '2021-03-22', 2),
(56, 3, '2920.00', '2021-03-23', 1),
(57, 1, '1664.00', '2021-03-23', 2),
(58, 1, '1234.00', '2021-03-24', 3),
(59, 1, '1404.00', '2021-03-26', 1),
(60, 1, '1585.00', '2021-03-27', 2),
(61, 2, '1234.00', '2021-03-27', 3),
(62, 2, '1388.00', '2021-03-28', 1),
(63, 2, '1100.00', '2021-03-29', 2),
(64, 1, '1270.00', '2021-03-30', 3),
(65, 1, '1471.00', '2021-04-01', 1),
(66, 4, '1650.00', '2021-04-01', 3),
(67, 1, '1297.00', '2021-04-03', 2),
(68, 3, '2667.00', '2021-04-04', 1),
(69, 3, '2606.00', '2021-04-05', 1),
(70, 1, '1585.00', '2021-04-05', 3),
(71, 1, '854.00', '2021-04-07', 1),
(72, 1, '970.00', '2021-04-10', 2),
(73, 3, '4545.00', '2021-04-11', 2),
(74, 3, '5602.50', '2021-04-11', 3),
(75, 1, '1489.00', '2021-04-12', 1),
(76, 2, '635.00', '2021-04-12', 2),
(77, 2, '1608.00', '2021-04-13', 2),
(78, 2, '511.00', '2021-04-15', 1),
(79, 1, '1085.00', '2021-04-14', 3),
(80, 4, '1162.00', '2021-04-16', 3),
(81, 1, '1028.00', '2021-04-18', 2),
(82, 1, '1555.00', '2021-04-19', 1),
(83, 1, '860.00', '2021-04-20', 1);
...
DROP TABLE IF EXISTS `dtritem`;
CREATE TABLE IF NOT EXISTS `dtritem` (
  `dtRNo` int NOT NULL,
  `fdNo` int NOT NULL,
  `fdQty` int NOT NULL,
  `dtItemCal` decimal(7,2) NOT NULL,
  PRIMARY KEY (`dtRNo`,`fdNo`),
  KEY `fdNo` (`fdNo`)
...
DROP TABLE IF EXISTS `favoritea`;
CREATE TABLE IF NOT EXISTS `favoritea` (
  `mNo` int NOT NULL,
  `infoNo` int NOT NULL,
  PRIMARY KEY (`infoNo`,`mNo`),
  KEY `mNo` (`mNo`),
  KEY `infoNo` (`infoNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `follow` (
  ...
  PRIMARY KEY (`mNo`,`mNoFollow`),
  KEY `mNoFollow` (`mNoFollow`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `food` (
  `fdNo` int NOT NULL AUTO_INCREMENT,
...
(105, 'ENERGY BALL', 100, 1, NULL, '0.5'),
(106, 'APPLE BAR', 130, 1, NULL, '1.0'),
(107, 'FRUIT BAR', 140, 1, NULL, '1.5'),
(108, 'PEANUT BAR', 200, 1, NULL, '1.0'),
(109, 'CHOCOLATE ORANGE BAR', 190, 1, NULL, '1.0'),
(110, 'CARAMEL BAR', 170, 1, NULL, '1.5'),
(111, 'FRUIT CEREAL', 120, 1, NULL, '1.5'),
(112, 'NUTTY CEREAL', 130, 1, NULL, '1.0'),
(113, 'STRABERRY CEREAL', 110, 1, NULL, '0.5'),
(114, 'BERRY CEREAL', 120, 1, NULL, '1.5'),
(115, 'COCONUT CEREAL', 140, 1, NULL, '1.0'),
(116, 'APRICOT CEREAL', 110, 1, NULL, '1.0'),
(117, 'VEGGIE CRACKERS', 90, 1, NULL, '1.5'),
(118, 'POTATO CRACKERS', 100, 1, NULL, '1.0'),
(119, 'BEETROOT CRACKERS', 110, 1, NULL, '1.5'),
(120, 'SEA SALT CRACKERS', 120, 1, NULL, '1.0'),
...
(14, 2, '8 Kettlebell Exercises For Everyone', './infoImg/info1_14.jpg', './infoImg/info2_14.jpg', './infoImg/info3_14.jpg', 'It’s no surprise kettlebell training is on the rise. There’s a good reason: Everyone can benefit from kettlebell exercises. “The kettlebell is an extremely versatile piece of exercise equipment that can be used for Olympic-style training, strength training, HIIT and mobility,” says Colin Laughlin, a certified strength and conditioning coach.Kettlebells have a unique shape that lets you blast your body in ways dumbbells can’t. You can pull, push, twist and swing them to get leaner, stronger and more powerful. Plus, they’re easier on your wrists than dumbbells. Also, because of their offset weight, the gravitational pull goes straight down, instead of from side-to-side with a dumbbell (which is shaped like a teeter-totter).', 'Plus, kettlebells are incredibly convenient. “One kettlebell can, in some ways, replace an entire gym if you are creative enough,” says Grayson Wickham, DPT, a physical therapist and founder of Movement Vault. “When you add a few different kettlebell weight options into the mix, your workout capabilities are endless. During this quarantine time in New York City, my apartment gym has consisted mostly of my five different-weighted kettlebells.”', '1.KETTLEBELL DEADLIFT2.KETTLEBELL GOBLET SQUAT3.KETTLEBELL SWING4.KETTLEBELL GOBLET STEPUPS5.KETTLEBELL CURTSY LUNGE6.KETTLEBELL PUSH-PRESS7.KETTLEBELL SINGLE-ARM BOTTOMS-UP PRESS8.SPLIT-STANCE KETTLEBELL ROW', 1, 0, '2021-04-05 21:21:00'),
(15, 3, '4 essential nutrients,are you getting enough?', './infoImg/info1_15.jpg', './infoImg/info2_15.jpg', './infoImg/info3_15.jpg', 'Over time, a shortfall of these nutrients may affect different aspects of your health, from teeth and bones to your heart, gut, muscles, blood pressure, weight, and more.What is a nutritional shortfall?Nutritional advice can be confusing. Eat more of this, less of that. Make sure you get enough — but not too much. It’s no wonder many people have so-called nutritional shortfalls, where their diet lacks sufficient essential nutrients.According to the guidelines, these four are “considered dietary components of public health concern for the general US population.” That’s government talk for: these nutrients help you stay healthy, and you probably should eat more of them.Four nutrients you need — and where to find them.', 'CalciumHow much: women: 1,000 to 1,200 milligrams (mg); men: 1,000 mg8 ounces of plain, nonfat yogurt: 488 mg; 1 cup low-fat or soy milk: 301 to 305 mg; 1 cup cooked spinach: 245 mg; 1/2 cup tofu: 434 mg.PotassiumHow much: women: 2,600 mg; men: 3,400 mg1 cup cooked lima beans: 969 mg; 1 medium baked potato with skin: 926 mg; 1 cup cooked acorn squash: 896 mg; 1 medium banana: 451 mg; 3 ounces skipjack tuna: 444 mg.', 'Dietary fiberHow much? women 22 to 28 grams (g); men: 28 to 34 g1 cup shredded wheat cereal: 6.2 g; 3 cups popcorn: 5.8 g; 1/2 cup navy or white cooked beans: 9.3 to 9.6 g; 1 cup berries (raspberries, blackberries, blueberries): 6.2 g to 8 g.Vitamin Dwomen and men 70 or younger: 600 international units (IU); women and men 71 and older: 800 IU', 1, 0, '2021-04-05 21:21:00'),
(16, 3, 'Why Calorie Counting Is a Complex Formula', './infoImg/info1_16.jpg', './infoImg/info2_16.jpg', './infoImg/info3_16.jpg', 'Consuming foods that supply calories is essential for supplying the body with energy to perform the basic functions of life such as keeping a heart beating and everything up to and including running a marathon. After all, a calorie is a unit of energy. Staying accountable, and having a record of changes being made.However, calories in versus calories out is a complex equation and should be used as a guideline along with other metrics to assess the quality of eating habits and especially as a tool for weight change.1.YOU CAN’T ACCOUNT FOR EVERY SINGLE CALORIEThe less processed food on your plate, the more energy you will output to digest it and the fewer calories that will be absorbed from that food.', '2. FOOD AND EXERCISE OFFER MORE THAN A CALORIC VALUEThis matters for long-term weight loss as workouts that stimulate more internal adaptations, regardless of calorie burn, create a generally stronger and more metabolically active body over time. When choosing foods to eat and workouts to do, aim to think of the long-term implications on overall health over the immediate caloric value.', '3. LABELS CAN BE MISLEADINGWhile research shows the majority of labels on packaged snack food is 90% accurate, some items fall surprisingly outside that range. Report found a popular diet ice cream to have 46% more calories than reported on the label, while another similar variety had 16% more calories than reported. One of those is FDA legal, one is not, but both lead to frustration of stalled weight progress by contributing more calories than you are counting.', 1, 0, '2021-04-05 21:21:00'),
(17, 3, 'Staying Healthy', './infoImg/info1_17.jpg', './infoImg/info2_17.jpg', './infoImg/info3_17.jpg', 'Maintaining good health doesn\'t happen by accident. It requires work, smart lifestyle choices, and the occasional checkup and test.A healthy diet is rich in fiber, whole grains, fresh fruits and vegetables, \"good\" or unsaturated fats, and omega-3 fatty acids. These dietary components turn down inflammation, which can damage tissue, joints, artery walls, and organs. Going easy on processed foods is another element of healthy eating. Sweets, foods made with highly refined grains, and sugar-sweetened beverages can cause spikes in blood sugar that can lead to early hunger. High blood sugar is linked to the development of diabetes, obesity, heart disease, and even dementia.', 'The Mediterranean diet meets all of the criteria for good health, and there is convincing evidence that it is effective at warding off heart attack, stroke, and premature death. The diet is rich in olive oil, fruits, vegetables, nuts and fish; low in red meats or processed meats; and includes a moderate amount of cheese and wine.Physical activity is also necessary for good health. It can greatly reduce your risk of heart disease, stroke, breast and colon cancer, depression, and falls.', 'Finding ways to reduce stress is another strategy that can help you stay healthy, given the connection between stress and a variety of disorders. There are many ways to bust stress. Try, meditation, mindfulness, yoga, playing on weekends, and taking vacations.If something happens to your health, a physician you know —and who knows you — is in the best position to help. He or she will also recommend tests to check for hidden cancer or other conditions.', 1, 0, '2021-04-05 21:21:00'),
(18, 3, '3 simple ways to get more restful slee', './infoImg/info1_18.jpg', './infoImg/info2_18.jpg', './infoImg/info3_18.jpg', 'The following three simple steps can help you sleep better.1. Cut down on caffeineCaffeine drinkers may find it harder to fall asleep than people who don\'t drink caffeine. Once they drift off, their sleep is shorter and lighter. For some, a single cup of coffee in the morning means a sleepless night. That may be because caffeine blocks the effects of adenosine, a neurotransmitter thought to promote sleep. Caffeine can also interrupt sleep by increasing the need to urinate during the night.People who suffer from insomnia should avoid caffeine as much as possible, since its effects can endure for many hours.Those who can\'t or don\'t want to give up caffeine should avoid it after 2 p.m., or noon if they are especially caffeine-sensitive.', '2. Stop smoking or chewing tobaccoNicotine is a central nervous system stimulant that can cause insomnia.People who kick the habit fall asleep more quickly and wake less often during the night. Sleep disturbance and daytime fatigue may occur during the initial withdrawal from nicotine, but even during this period, many former users report improvements in sleep. If you continue to use tobacco, avoid smoking or chewing it for at least one to two hours before bedtime.', '3. Limit alcohol intakeAlcohol depresses the nervous system, so a nightcap may seem to help some people fall asleep. Alcohol may be responsible for up to 10% of chronic insomnia cases. Also, alcohol can worsen snoring and other sleep breathing problems, sometimes to a dangerous extent. Even one drink can make a sleep-deprived person drowsy. In an automobile, the combination significantly increases a person\'s chance of having an accident.', 1, 0, '2021-04-05 21:21:00'),
...
(7, 'Stan', 'Stan07', 'F12345', 'Stan07@gmail.com', NULL, './memberImg/M_stan.jpg', NULL, 1, 173, NULL, 100, 1, 0, 0, 2, NULL, NULL, NULL, 3, 1, '2021-04-20'),
(8, 'Chester', 'Chester08', 'G12345', 'Chester08@gmail.com', NULL, './memberImg/M_chester.jpg', NULL, 1, 175, NULL, 100, 1, 0, 0, 2, NULL, NULL, NULL, 3, 1, '2021-04-20'),
(9, 'Una', 'Una009', 'H12345', 'Una009@gmail.com', NULL, './memberImg/F_una.jpg', NULL, 2, 171, NULL, 100, 1, 0, 0, 1, NULL, NULL, NULL, 3, 1, '2021-04-20'),
(10, 'Chloe', 'Chloe10', 'I12345', 'Chloe10@gmail.com', NULL, './memberImg/F_chloe.jpg', NULL, 2, 168, NULL, 100, 1, 0, 0, 1, NULL, NULL, NULL, 3, 1, '2021-04-20');
...
(47, 7, 18, '太有錢了吧 一次買那麼多 大戶！', 1, '2021-03-31 14:21:00'),
(48, 2, 18, '最喜歡看到這種開箱文！超棒的~已經追蹤你了', 1, '2021-03-31 15:11:00'),
(49, 2, 18, '期待下次的分享', 1, '2021-03-31 20:44:00'),
(50, 9, 19, '大神最厲害', 1, '2021-04-01 13:43:00'),
(51, 3, 19, '我晚餐也要吃斜管麵', 1, '2021-04-01 14:02:00'),
(52, 5, 19, '跟著做了一次 我果然沒有天分Q_Q 我用買的就好', 1, '2021-04-01 15:48:00'),
(53, 1, 19, '看起來好好吃~已追蹤', 1, '2021-04-01 16:18:00'),
(54, 2, 19, '哇 也太厲害了', 1, '2021-04-01 17:38:00'),
(55, 8, 19, '朋友推薦來的 看起來超好吃', 1, '2021-04-01 18:22:00'),
(56, 1, 20, '這個口味真的讚', 1, '2021-04-02 13:19:00'),
(57, 5, 20, '贊成 你買的我都買過', 1, '2021-04-02 14:32:00'),
(58, 8, 20, '好像很好吃~', 1, '2021-04-02 15:31:00'),
(59, 5, 21, '要繼續努力 設定下一個目標', 1, '2021-04-03 08:42:00'),
(60, 2, 21, '嗚嗚嗚太感動了', 1, '2021-04-03 08:45:00'),
(61, 7, 21, '佩服你的毅力', 1, '2021-04-03 08:54:00'),
(62, 6, 21, '加油加油', 1, '2021-04-05 09:17:00'),
(63, 10, 21, '你一定會復胖的！', 1, '2021-04-03 10:42:00'),
(64, 2, 22, '最喜歡看到這種開箱文！超棒的~已經追蹤你了', 1, '2021-04-03 10:43:00'),
(65, 7, 22, '太有錢了吧 一次買那麼多 大戶！', 1, '2021-04-03 10:51:00'),
(66, 2, 22, '還有下一集嗎?', 1, '2021-04-03 10:59:00'),
(67, 1, 22, '期待下次的分享', 1, '2021-04-03 11:12:00'),
(68, 1, 21, '好感動~我會繼續努力的', 1, '2021-04-03 11:42:00'),
(69, 5, 23, '佩服你的毅力', 1, '2021-04-03 11:44:00'),
(70, 2, 23, '加油加油', 1, '2021-04-03 11:46:00'),
(71, 6, 23, '佩服你的毅力', 1, '2021-04-03 11:52:00'),
(72, 2, 1, '回兩個月前的發文！能達成目標實在是太厲害了', 1, '2021-04-03 11:58:00'),
(73, 7, 1, '佩服你的毅力', 1, '2021-04-03 11:59:00'),
(74, 7, 24, '佩服你的毅力', 1, '2021-04-03 12:14:00'),
(75, 2, 24, '嗚嗚嗚太感動了', 1, '2021-04-03 12:16:00'),
(76, 4, 24, '加油加油', 1, '2021-04-03 12:20:00'),
(77, 1, 24, '期待下次的分享', 1, '2021-04-03 12:24:00'),
(78, 3, 24, '好感動~我會繼續努力的', 1, '2021-04-03 12:33:00');
...
(1, 2, 2, 100, 2010, '王小胖', '新北市三重區中正北路20號', '0923456781', '2021-02-28 22:34:00'),
(2, 5, 2, 100, 10580, '黃愛買', '台中市西屯區中正路20號', '0956781234', '2021-03-05 09:31:00'),
(3, 1, 2, 300, 700, '陳大胖', '桃園市中壢區復興路46號8樓', '0912345678', '2021-04-01 10:33:00'),
(4, 3, 2, 100, 2220, '張瘦瘦', '台中市中區中正路20號', '0934567812', '2021-04-02 17:04:00'),
(5, 2, 2, 200, 700, '王小胖', '新北市三重區中正北路20號', '0923456781', '2021-04-11 09:43:00'),
(6, 1, 2, 300, 700, '陳大胖', '桃園市中壢區復興路46號8樓', '0912345678', '2021-04-16 23:35:00'),
(7, 5, 2, 500, 15700, '黃愛買', '台中市西屯區中正路20號', '0956781234', '2021-04-17 10:00:00'),
(8, 1, 2, 0, 850, '陳大胖', '桃園市中壢區復興路46號8樓', '0912345678', '2021-04-18 23:20:00'),
(9, 2, 2, 300, 700, '王小胖', '新北市三重區中正北路20號', '0923456781', '2021-04-19 02:44:00'),
(10, 1, 2, 0, 1700, '陳大胖', '桃園市中壢區復興路46號8樓', '0912345678', '2021-04-19 21:12:00'),
(11, 5, 2, 0, 15240, '黃愛買', '台中市西屯區中正路20號', '0956781234', '2021-04-20 12:33:00'),
(12, 1, 2, 0, 1800, '陳大胖', '桃園市中壢區復興路46號8樓', '0912345678', '2021-04-20 22:17:00');
...
(7, 1, './postImg/7.jpg', '', 1, 4, '2021-03-04 00:59:00'),
(8, 2, './postImg/8.jpg', '', 1, 3, '2021-03-05 19:15:00'),
(9, 2, './postImg/9.jpg', '', 1, 3, '2021-03-06 19:31:00'),
(10, 1, './postImg/10.jpg', '', 1, 5, '2021-03-08 11:34:00'),
...
(15, 1, './postImg/15.jpg', '', 1, 2, '2021-03-20 08:07:00'),
...
(18, 5, '', '分享我這次前二喜歡的口味！<br>PEANUT BAR 吃起來口感層次有更加豐富，香氣相當夠味。<br>HOCOLATE ORANGE BAR 外層酥脆的巧克力，重點是真的不會甜！', 1, 3, '2021-03-31 00:51:00'),
(19, 4, './postImg/19.jpg', 'PENNE WITH SPRING VEGETABLES | MYFITNESSPAL’S RECIPES<br>Nutrition (per serving): Calories: 330; Total Fat: 9g; Saturated Fat: 1g; Monounsaturated Fat: 6g; Cholesterol: 0mg; Sodium: 16mg; Carbohydrate: 54g; Dietary Fiber: 5g; Sugar: 5g; Protein: 11g', 1, 6, '2021-04-01 06:12:00'),
(20, 2, '', '天啊 這個CARAMEL BAR讓我驚為天人相見恨晚Q_Q 我要買十個', 1, 3, '2021-04-02 07:47:00'),
(21, 1, './postImg/21.jpg', '嗚嗚嗚嗚終於達到目標85', 1, 6, '2021-04-03 08:37:00'),
(22, 5, '', '已經習慣從ft. shop補貨零食<br>VEGGIE CRACKERS 非常健康的口味<br>SEA SALT CRACKERS 口感有層次，會再回購的口味！', 1, 4, '2021-04-03 10:37:00'),
(23, 1, './postImg/23.jpg', '', 1, 3, '2021-04-03 11:41:00'),
(24, 3, './postImg/24.jpg', '', 1, 5, '2021-04-03 12:12:00'),
(25, 10, '', '廣告貼文', 1, 0, '2021-04-03 12:24:25');
...
DROP TABLE IF EXISTS `sprecord`;
CREATE TABLE IF NOT EXISTS `sprecord` (
  `spRNo` int NOT NULL AUTO_INCREMENT,
  `mNo` int NOT NULL,
...
(1, 1, '1190.00', '2021-02-21'),
(2, 1, '2915.00', '2021-02-26'),
(3, 1, '3360.00', '2021-03-03'),
(4, 3, '81.00', '2021-03-08'),
(5, 1, '2190.00', '2021-03-08'),
(6, 4, '180.00', '2021-03-09'),
(7, 1, '1420.00', '2021-03-17'),
(8, 1, '396.00', '2021-03-22'),
(9, 3, '509.60', '2021-03-29'),
(10, 1, '999.00', '2021-04-05'),
(11, 1, '1192.50', '2021-04-12'),
(12, 1, '612.00', '2021-04-19'),
(13, 3, '198.00', '2021-04-20');
...
DROP TABLE IF EXISTS `spritem`;
CREATE TABLE IF NOT EXISTS `spritem` (
  `spRNo` int NOT NULL,
  `spNo` int NOT NULL,
  `spTimeSpan` int NOT NULL,
  `spItemCal` decimal(7,2) NOT NULL,
  PRIMARY KEY (`spRNo`,`spNo`),
  KEY `spNo` (`spNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `weigth` (
  `mNo` int NOT NULL,
  `wDate` date NOT NULL,
  `wWeight` decimal(4,1) NOT NULL,
  PRIMARY KEY (`mNo`,`wDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
